...
public class MasonryOvenBlocks {
    ...
    public static final RecipeType<MasonryOvenRecipe> MASONRY_OVEN_RECIPE_TYPE=new RecipeType<MasonryOvenRecipe>(){@Override public String toString(){return BLOCK_ID;}};

    public static final RecipeSerializer<MasonryOvenRecipe> MASONRY_OVEN_RECIPE_SERIALIZER = new CookingRecipeSerializer<>(
            MasonryOvenRecipe::new, 200);
    public static final BlockEntityType<MasonryOvenBlockEntity> MASONRY_OVEN_BLOCK_ENTITY = 
        BlockEntityType.Builder.create(MasonryOvenBlockEntity::new, MASONRY_OVEN_BLOCK).build(null);
    ...
    static {
         SCREEN_HANDLER_TYPE =  ScreenHandlerRegistry.registerSimple(
                new Identifier(ColorfulMasonry.MOD_ID, BLOCK_ID),
